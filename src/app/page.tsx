  ...
  return (
    <section className="container">
      ...
      <p className="mt-4 text-pretty text-lg text-foreground/60">
        Добро пожаловать на LORDFILMZ — удобный онлайн-кинотеатр, где вы можете смотреть
      ...
      <p className="mt-4 text-pretty text-lg text-foreground/60">
        LORDFILMZ — это выбор для тех, кто ценит комфорт, скорость и качество. Смотрите

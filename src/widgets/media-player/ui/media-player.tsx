...
export async function MediaPlayer({ kinopoiskId }: MediaPlayerProps) {
  ...
  if (!players || !players.length) {
    return (
      <section>
        <div className="container flex w-full flex-col items-center justify-center overflow-hidden rounded-large border-x bg-default-100 sm:aspect-[16/9] md:aspect-[21/9]">

    ...
    <section className="container overflow-hidden">
      <div className="flex items-center justify-between pt-4">
        ...
        <div className="flex gap-2">
          <Button size="lg" aria-label="Перемотать карусель назад" isIconOnly onPress={scrollPrev}>
            <ChevronLeft className="size-5" strokeWidth={2.5} />
          </Button>
          <Button size="lg" aria-label="Перемотать карусель вперёд" isIconOnly onPress={scrollNext}>
